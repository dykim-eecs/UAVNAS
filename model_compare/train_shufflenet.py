# train_shufflenet.py (similar changes)
import os
import torch
import argparse
...
def main():
    parser = argparse.ArgumentParser("ShuffleNetV2 Training")
    ...
    model = models.shufflenet_v2_x1_0(weights=None, num_classes=args.classes)
    model.conv1[0] = torch.nn.Conv2d(2, 24, kernel_size=3, stride=2, padding=1, bias=False)
    ...
    print("Exported to shufflenet.onnx")
