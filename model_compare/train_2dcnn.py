# train_2dcnn.py (add ONNX export)
import os
import torch
import argparse
...
def main():
    parser = argparse.ArgumentParser("Simple2DCNN Training")
    ...
    model = Simple2DCNN(args.classes).to(device)
    ...
    torch.save(model.state_dict(), '2dcnn.pt')
    ...
    torch.onnx.export(model, dummy_input, '2dcnn.onnx', opset_version=11)
    print("Exported to 2dcnn.onnx")
